package com.victorkayk.algafood.api.exception;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleUncaught(Exception ex, WebRequest request) {
        ...
        return handleExceptionInternal(ex, exceptionResponse, new HttpHeaders(), getHttpStatus(ErrorEnum.INTERNAL_ERROR.getStatus()), request);
    }
